...
# Generate data for 2000 rows
rows_diverse = generate_diverse_data(2000)

# Create a DataFrame
df_diverse = pd.DataFrame(rows_diverse, columns=columns)

# Save to a CSV file
file_path_diverse = "C:/Users/tahir/Desktop/incrementalDataAnalytics/Data/salesData.csv"
df_diverse.to_csv(file_path_diverse, index=False)